...
/** Utility functions used by the Bitstock Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitstock addresses in monospace font
...
// Parse "bitstock:" URI into recipient object, return true on successful parsing
