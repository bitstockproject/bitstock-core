...
#ifndef Bitstock_QT_WALLETMODEL_H
#define Bitstock_QT_WALLETMODEL_H
...
/** Interface to Bitstock wallet from Qt view code. */
...
#endif // Bitstock_QT_WALLETMODEL_H
