...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BitstockGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BitstockGUI *gui, double posX = 3);
