...
#include "qt/bitstock/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/bitstock/lockunlock.h"
#include "qt/bitstock/qtutils.h"
#include "qt/bitstock/receivedialog.h"
...
TopBar::TopBar(BitstockGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Bitstock")
    updateDisplayUnit();
