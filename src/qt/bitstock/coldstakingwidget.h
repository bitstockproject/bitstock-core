...
#include "qt/bitstock/furabstractlistitemdelegate.h"
#include "qt/bitstock/txviewholder.h"
#include "qt/bitstock/tooltipmenu.h"
#include "qt/bitstock/sendmultirow.h"
#include "qt/bitstock/coldstakingmodel.h"
#include "qt/bitstock/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(BitstockGUI* parent);
    ~ColdStakingWidget();
