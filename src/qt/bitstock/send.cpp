...
#include "qt/bitstock/forms/ui_send.h"
#include "qt/bitstock/addnewcontactdialog.h"
#include "qt/bitstock/qtutils.h"
#include "qt/bitstock/sendchangeaddressdialog.h"
#include "qt/bitstock/optionbutton.h"
#include "qt/bitstock/sendconfirmdialog.h"
#include "qt/bitstock/myaddressrow.h"
#include "qt/bitstock/guitransactionsutils.h"
...
SendWidget::SendWidget(BitstockGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    /* Address */
    ui->labelSubtitleAddress->setText(tr("Bitstock address or contact label"));
