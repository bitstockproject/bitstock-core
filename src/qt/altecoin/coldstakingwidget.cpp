...
#include "qt/bitstock/forms/ui_coldstakingwidget.h"
#include "qt/bitstock/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/bitstock/requestdialog.h"
#include "qt/bitstock/tooltipmenu.h"
#include "qt/bitstock/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(BitstockGUI* parent) :
    PWidget(parent),
