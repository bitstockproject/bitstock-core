...
#include "qt/bitstock/forms/ui_addresseswidget.h"
#include "qt/bitstock/addresslabelrow.h"
#include "qt/bitstock/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(BitstockGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Bitstock address"));
