...
#ifndef Bitstock_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Bitstock_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Bitstock_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
