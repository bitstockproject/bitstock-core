...
#include "qt/bitstock/settings/settingsnetworkwidget.h"
#include "qt/bitstock/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitstock/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BitstockGUI* _window, QWidget *parent) :
