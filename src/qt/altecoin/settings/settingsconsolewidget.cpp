...
#include "qt/bitstock/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitstock/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BitstockGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Bitstock RPC console.") + "<br>" +
