...
#include "qt/bitstock/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitstock/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BitstockGUI* _window, QWidget *parent) :
