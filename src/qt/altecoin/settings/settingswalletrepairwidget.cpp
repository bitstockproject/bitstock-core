...
#include "qt/bitstock/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitstock/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BitstockGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BitstockGUI::handleRestart()
