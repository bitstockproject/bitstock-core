...
#include "qt/bitstock/settings/forms/ui_settingswidget.h"
#include "qt/bitstock/settings/settingsbackupwallet.h"
#include "qt/bitstock/settings/settingsbittoolwidget.h"
#include "qt/bitstock/settings/settingswalletrepairwidget.h"
#include "qt/bitstock/settings/settingswalletoptionswidget.h"
#include "qt/bitstock/settings/settingsmainoptionswidget.h"
#include "qt/bitstock/settings/settingsdisplayoptionswidget.h"
#include "qt/bitstock/settings/settingsmultisendwidget.h"
#include "qt/bitstock/settings/settingsinformationwidget.h"
#include "qt/bitstock/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(BitstockGUI* parent) :
    PWidget(parent),
