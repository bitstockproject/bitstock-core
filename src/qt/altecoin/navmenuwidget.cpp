...
#include "qt/bitstock/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(BitstockGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-bitstock");
