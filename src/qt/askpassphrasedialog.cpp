...
#include "qt/bitstock/loadingdialog.h"
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            if (newpass1 == newpass2) {
                ...
                BitstockGUI* window = static_cast<BitstockGUI*>(parentWidget());
...
{
    BitstockGUI* gui = static_cast<BitstockGUI*>(parentWidget());
...
{
    hide();
    static_cast<BitstockGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
