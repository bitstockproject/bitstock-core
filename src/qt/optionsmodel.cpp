...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset){
    ...
    if (settings.contains("nAnonymizeBitstockAmount") || reset)
        SoftSetArg("-anonymizebitstockamount", settings.value("nAnonymizeBitstockAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitstock.cpp during shotdown to also remove the window positions
