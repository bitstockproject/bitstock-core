// Copyright (c) 2017-2018 The Bitstock developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Bitstock_ZBSOCKWALLET_H
#define Bitstock_ZBSOCKWALLET_H
...
public:
    CzBSOCKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBSOCK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBSOCK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
