...
#ifndef Bitstock_ZBSCKWALLET_H
#define Bitstock_ZBSCKWALLET_H
...
public:
    CzBSCKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBSCK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBSCK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
