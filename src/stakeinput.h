...
#ifndef Bitstock_STAKEINPUT_H
#define Bitstock_STAKEINPUT_H
...
// zBSOCKStake can take two forms
...
public:
    ...
    bool IsZBSOCK() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZBSOCK() override { return false; }
