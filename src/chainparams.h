 ...
 * Bitstock system. There are three: the main network on which people trade goods
...
public:
    ...
    int BitstockBadBlockTime() const { return nBitstockBadBlockTime; }
    int BitstockBadBlocknBits() const { return nBitstockBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBitstockBadBlockTime;
    unsigned int nBitstockBadBlocknBits;
