...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitstock Core bitstock-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitstock-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitstock transaction") + "\n" +
                               "  bitstock-tx [options] -create [commands]   " + _("Create hex-encoded bitstock transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitstock transaction
