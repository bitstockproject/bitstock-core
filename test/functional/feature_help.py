...
"""Verify that starting bitstock with -h works as expected."""
import subprocess

from test_framework.test_framework import BitstockTestFramework
from test_framework.util import assert_equal

class HelpTest(BitstockTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitstock with -h for help text")
        ...
        self.log.info("Start bitstock with -version for version information")
