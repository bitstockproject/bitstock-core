...
from test_framework.bitstock_node import BitstockTestNode
...
class Bitstock_ColdStakingTest(BitstockTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BitstockTestNode())
