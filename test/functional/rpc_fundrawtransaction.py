...
class RawTransactionsTest(BitstockTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitstock address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitstock address" in e.error['message'])
