...
RESOURCES += src/qt/bitstock.qrc src/qt/bitstock_locale.qrc

TRANSLATIONS += src/qt/locale/bitstock_bg.ts \
                src/qt/locale/bitstock_de.ts \
                src/qt/locale/bitstock_en.ts \
                src/qt/locale/bitstock_es.ts \
                src/qt/locale/bitstock_fi.ts \
                src/qt/locale/bitstock_fr.ts \
                src/qt/locale/bitstock_it.ts \
                src/qt/locale/bitstock_ja.ts \
                src/qt/locale/bitstock_pl.ts \
                src/qt/locale/bitstock_pt.ts \
                src/qt/locale/bitstock_ru.ts \
                src/qt/locale/bitstock_sk.ts \
                src/qt/locale/bitstock_sv.ts \
                src/qt/locale/bitstock_vi.ts \
                src/qt/locale/bitstock_zh_CN.ts \
                src/qt/locale/bitstock_zh_TW.ts
