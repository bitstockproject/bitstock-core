...
This means one can have an always-on bitstockd instance running, and another local bitstockd/bitstock-qt instance which connects to this node and receives blocks from it.
