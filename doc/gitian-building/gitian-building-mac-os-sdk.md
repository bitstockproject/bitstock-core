...
The script [extract-osx-sdk.sh](https://https://github.com/Bitstock-blockchain/BITSTOCK/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitstock/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://https://github.com/Bitstock-blockchain/BITSTOCK/blob/master/doc/README_osx.md) for troubleshooting tips.