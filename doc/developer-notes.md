...
Run with the `-testnet` option to run with "play BSCKs (tBSCK)" on the test network, if you
...
([`valgrind.supp`](https://https://github.com/Bitstock-blockchain/BITSTOCK/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates BSCKs (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:bitstock-bitstock/Bitstock.git
