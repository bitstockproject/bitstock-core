Bitstock Core version *3.4.0* is now available from:  <https://github.com/bitstock-altc/bitstock/releases>
...
### Wallet
 ...
 - #971 `bbeabc4d63` [Wallet][zBSOCK] zc public spend parse crash in wallet startup. (furszy)
