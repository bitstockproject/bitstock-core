...
[gitian.sigs](https://github.com/bitstockproject/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@bitstock.org) and he will commit them.
