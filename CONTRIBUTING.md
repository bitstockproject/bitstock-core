Contributing to Bitstock Core
============================

The Bitstock Core project operates an open contributor model where anyone is
...
[Translation Process](https://https://github.com/Bitstock-blockchain/BITSTOCK/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bitstock Core project, and is not to be
confused with overall Bitstock Network Protocol consensus changes.

Whether a pull request is merged into Bitstock Core rests with the project merge
...
Patches that change Bitstock consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bitstock consensus, it must have been
...
The project leader is the release manager for each Bitstock Core release.
